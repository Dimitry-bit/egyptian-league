...
public class JsonConverterShort extends JsonConverter<Short> {
    ...
    @Override
    public void serialize(Queue<JsonToken> tokens, Short value, JsonSerializerOptions options) {
        tokens.add(new JsonToken(value.toString(), JsonTokenType.NUMBER));
    }

    @Override
    public Short deserialize(JsonElement element, Type typeToConvert, JsonSerializerOptions options) {
