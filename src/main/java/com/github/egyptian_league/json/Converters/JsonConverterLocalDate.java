...
public class JsonConverterLocalDate extends JsonConverter<LocalDate> {

    @Override
    public TypeToken<LocalDate> getMyType() {
        return TypeToken.get(LocalDate.class);
    }
    ...
    public Object deserialize(JsonElement element, TypeToken<?> typeToConvert, JsonSerializerOptions options) {
        ...
        return LocalDate.parse(element.getAsJsonPrimitive().getAsString());
    }
}
